(function (global, factory) {
  ...
  exports.fnproxyList = fnproxyList;
  ...
  var proxyList = process.env.THEPIRATEBAY_PROXY_LIST || ['https://thepiratebay.org'];
  ...
  function search() {
    ...
    return (0, _Parser.parsePage)(url, _Parser.parseResults, rest.filter, null, null, opts.proxyList || searchDefaults.proxyList);
  }
  ...
  function fnproxyList() {
    return (0, _Parser.getProxyList)();
  }
