(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'babel-runtime/core-js/promise', 'babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator', 'cheerio', 'node-fetch', 'url-parse', './PirateBay'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('babel-runtime/core-js/promise'), require('babel-runtime/regenerator'), require('babel-runtime/helpers/asyncToGenerator'), require('cheerio'), require('node-fetch'), require('url-parse'), require('./PirateBay'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.promise, global.regenerator, global.asyncToGenerator, global.cheerio, global.nodeFetch, global.urlParse, global.PirateBay);
    global.Parser = mod.exports;
  }
})(this, function (exports, _promise, _regenerator, _asyncToGenerator2, _cheerio, _nodeFetch, _urlParse, _PirateBay) {
  'use strict';
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              noDups = [];
              _context.next = 4;
              return (0, _nodeFetch2.default)('https://thepiratebay-proxylist.org/api/v1/proxies').then(function (res) {
                return res.text();
              });
            ...
            case 4:
              ...
              _context.next = 10;
              return (0, _nodeFetch2.default)('https://proxybay.one/').then(function (res) {
                return res.text();
              });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (!proxyUrls || !proxyUrls.length) proxyUrls = ['https://piratebays.red', 'https://baypirate.org', 'https://tpb.lc'];
                ...
                requests = proxyUrls.map(function (_url) {
                  ...
                  return (
                    ...
                    (0, _nodeFetch2.default)(_url.href, options).then(function (response) {
                      return response.text();
                    }).then(function (body) {
                      return body.includes('502: Bad gateway') || body.includes('403 Forbidden') || body.includes('Database maintenance') || body.includes('Origin DNS error') || !body.includes('<title>The Pirate Bay') ? _promise2.default.reject('Database maintenance, Cloudflare DNS error, 403 or 502 error') : _promise2.default.resolve({ from: _url.domain, body: body });
                    })
                  );
                });
  ...
  function parseResults() {
    ...
    var rawResults = $('#SearchResults table#searchResult tr:has(a.detLink)');
    ...
    var results = rawResults.map(function getRawResults() {
      ...
      var magnetLink = $(this).find('a[title="PirateBay Proxy :Download this torrent using magnet"]').attr('href');
